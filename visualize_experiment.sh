...
#set -x	
COMMAND="${REMOTEMATLAB} -nodisplay -r \"cd '${REMOTEPATH}';${STARTUPCOMMAND};showInteractiveHtml('${EXPERIMENTNAME}');\" "
echo ssh -X $REMOTEMACHINE "`echo $COMMAND`"
ssh -X $REMOTEMACHINE "`echo $COMMAND`"
